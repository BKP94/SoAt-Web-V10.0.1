CREATE TABLE sc_eoff_doc_inout (
	...
	officer_line1 varchar(100),
	officer_line2 varchar(100),
	officer_line3 varchar(100),
	officer_line4 varchar(100),
	officer_line5 varchar(100)
) ;
ALTER TABLE sc_eoff_doc_inout ADD PRIMARY KEY (doc_no,inout_status);
ALTER TABLE sc_eoff_doc_inout ALTER COLUMN doc_no SET NOT NULL;
ALTER TABLE sc_eoff_doc_inout ALTER COLUMN inout_status SET NOT NULL;

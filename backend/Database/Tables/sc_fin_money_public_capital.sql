...
ALTER TABLE sc_fin_money_public_capital ADD PRIMARY KEY (public_no,item_no);
ALTER TABLE sc_fin_money_public_capital ALTER COLUMN public_no SET NOT NULL;
ALTER TABLE sc_fin_money_public_capital ALTER COLUMN item_no SET NOT NULL;
ALTER TABLE sc_fin_money_public_capital ALTER COLUMN receive_year SET NOT NULL;
ALTER TABLE sc_fin_money_public_capital ALTER COLUMN receive_month SET NOT NULL;

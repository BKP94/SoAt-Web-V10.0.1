CREATE TABLE sc_hr_ucf_keep_placement (
...
ALTER TABLE sc_hr_ucf_keep_placement ADD PRIMARY KEY (keep_placement);
ALTER TABLE sc_hr_ucf_keep_placement ALTER COLUMN keep_placement SET NOT NULL;

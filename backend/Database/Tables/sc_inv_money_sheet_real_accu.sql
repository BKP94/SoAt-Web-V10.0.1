CREATE TABLE sc_inv_money_sheet_real_accu (
...
ALTER TABLE sc_inv_money_sheet_real_accu ADD PRIMARY KEY (account_year,moneysheet_code,moneysheet_seq);
ALTER TABLE sc_inv_money_sheet_real_accu ALTER COLUMN account_year SET NOT NULL;
ALTER TABLE sc_inv_money_sheet_real_accu ALTER COLUMN moneysheet_code SET NOT NULL;
ALTER TABLE sc_inv_money_sheet_real_accu ALTER COLUMN moneysheet_seq SET NOT NULL;

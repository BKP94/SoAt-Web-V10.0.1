CREATE TABLE sc_mem_m_membership_cc (
...
CREATE UNIQUE INDEX sc_mem_m_membership_cc ON sc_mem_m_membership_cc (membership_no);
ALTER TABLE sc_mem_m_membership_cc ALTER COLUMN membership_no SET NOT NULL;

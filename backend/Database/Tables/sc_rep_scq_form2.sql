...
ALTER TABLE sc_rep_scq_form2 ADD PRIMARY KEY (operate_date,loan_group,loan_item);
ALTER TABLE sc_rep_scq_form2 ALTER COLUMN operate_date SET NOT NULL;
ALTER TABLE sc_rep_scq_form2 ALTER COLUMN loan_group SET NOT NULL;
ALTER TABLE sc_rep_scq_form2 ALTER COLUMN loan_item SET NOT NULL;

...
ALTER TABLE sc_rep_scq_form7 ADD PRIMARY KEY (operate_date,item_type);
ALTER TABLE sc_rep_scq_form7 ALTER COLUMN operate_date SET NOT NULL;
ALTER TABLE sc_rep_scq_form7 ALTER COLUMN item_type SET NOT NULL;

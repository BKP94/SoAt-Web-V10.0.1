CREATE TABLE sc_sto_stock_place_detail (
...
ALTER TABLE sc_sto_stock_place_detail ADD PRIMARY KEY (doc_no,seq_no);
ALTER TABLE sc_sto_stock_place_detail ALTER COLUMN doc_no SET NOT NULL;
ALTER TABLE sc_sto_stock_place_detail ALTER COLUMN seq_no SET NOT NULL;

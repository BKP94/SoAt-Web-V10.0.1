...
public record PrenameDto(string Code, string? Name, string? Sex, string? MarriageStatus);
...
public record MarriageStatusDto(string Code, string? Name);
...
{
    public List<PrenameDto>         Prenames         { get; set; } = [];
    ...
    public List<MarriageStatusDto>  MarriageStatuses { get; set; } = [];

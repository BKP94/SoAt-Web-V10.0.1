...
{
    public class r_ktm_finance_payment_div : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public r_ktm_finance_payment_div()
        {
            InitializeComponent();
            //
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(r_ktm_finance_payment_div));
    ...
    "EventArgs e) {\r\n }\r\n";
        ...
        {
            sc.report.setNestReport(this, sender, Type.GetType("scReport.Reports.rcAccount.accEnd.r_ktm_finance_payment_div_nest_pay_detail"),null, this.GetCurrentColumnValue("RECEIPT_NO"),loan_group_code);
        ...
        {
            sc.report.setNestReport(this, sender, Type.GetType("scReport.Reports.rcAccount.accEnd.r_ktm_finance_payment_div_nest_emer"),null,this.GetCurrentColumnValue("RECEIPT_NO"),loan_group_code,loan_code);
        }
        ...
        {
            sc.report.setNestReport(this, sender, Type.GetType("scReport.Reports.rcAccount.accEnd.r_ktm_finance_payment_div_nest_loan_code"));
        }

        private void nest_sum_balance_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            sc.report.setNestReport(this, sender, Type.GetType("scReport.Reports.rcAccount.accEnd.r_ktm_finance_payment_div_nest_sum_balance"),null, this.GetCurrentColumnValue("RECEIPT_DATE"));
        }

        private void nest_sum_balance_1_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            sc.report.setNestReport(this, sender, Type.GetType("scReport.Reports.rcAccount.accEnd.r_ktm_finance_payment_div_nest_sum_balance1"),null, this.GetCurrentColumnValue("RECEIPT_DATE"));
        }

        private void nest_sum_balance_2_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            sc.report.setNestReport(this, sender, Type.GetType("scReport.Reports.rcAccount.accEnd.r_ktm_finance_payment_div_nest_sum_balance2"),null, this.GetCurrentColumnValue("RECEIPT_DATE"));
        }

        private void nest_fund_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            sc.report.setNestReport(this, sender, Type.GetType("scReport.Reports.rcAccount.accEnd.r_ktm_finance_payment_div_nest_fund"),null, this.GetCurrentColumnValue("RECEIPT_DATE"));
        }

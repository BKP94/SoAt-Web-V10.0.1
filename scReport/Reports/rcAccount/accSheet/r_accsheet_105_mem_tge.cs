...
{
    public partial class r_accsheet_105_mem_tge : DevExpress.XtraReports.UI.XtraReport
    {
        public r_accsheet_105_mem_tge()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcAccount.accSheet.r_accsheet_105_mem_tge_nest_sum");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcAccount.accSheet.r_accsheet_105_mem_tge_nest_mem");

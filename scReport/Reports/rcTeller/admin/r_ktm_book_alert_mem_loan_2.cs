...
{
    public partial class r_ktm_book_alert_mem_loan_2 : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_book_alert_mem_loan_2()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.admin.r_ktm_book_alert_mem_loan_2_nest_coll");

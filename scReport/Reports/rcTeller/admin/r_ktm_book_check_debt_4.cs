...
{
    public partial class r_ktm_book_check_debt_4 : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_book_check_debt_4()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.admin.r_ktm_book_check_debt_4_nest_coll");

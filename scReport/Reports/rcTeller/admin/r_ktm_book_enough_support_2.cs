...
{
    public partial class r_ktm_book_enough_support_2 : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_book_enough_support_2()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.admin.r_ktm_book_enough_support_2_nest_coll");

...
{
    public partial class r_ktm_book_trans_loan_list_1 : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_book_trans_loan_list_1()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.admin.r_ktm_book_trans_loan_list_1_nest_coll");

...
{
    public partial class r_ktm_req_resign_dead : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_req_resign_dead()
        {
            InitializeComponent();
        }
        ...
        private void r_ktm_req_resign_dead_nest_loan_coll_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.agenda.r_ktm_req_resign_dead_nest_loan_coll");
            sc.report.ofBeforePrint(this, (XRSubreport)sender, this.GetCurrentColumnValue("RESIGN_DOC_NO"));
        }

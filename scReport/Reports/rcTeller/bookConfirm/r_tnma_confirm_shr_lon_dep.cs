...
{
    public partial class r_tnma_confirm_shr_lon_dep : DevExpress.XtraReports.UI.XtraReport
    {
        public r_tnma_confirm_shr_lon_dep()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.bookConfirm.r_tnma_confirm_shr_lon_dep_nest");

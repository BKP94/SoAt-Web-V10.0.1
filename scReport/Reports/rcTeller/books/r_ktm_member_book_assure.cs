...
{
    public partial class r_ktm_member_book_assure : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_member_book_assure()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.books.r_ktm_member_book_assure_nest");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.books.r_ktm_member_book_assure_nest_loan");
            sc.report.ofBeforePrint(this, (XRSubreport)sender, this.GetCurrentColumnValue("MEMBERSHIP_NO"));
        }
    }
}

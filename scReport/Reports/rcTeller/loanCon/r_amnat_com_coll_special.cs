...
{
    public partial class r_amnat_com_coll_special : DevExpress.XtraReports.UI.XtraReport
    {
        public r_amnat_com_coll_special ()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setNestReport(this, sender, Type.GetType("scReport.Reports.rcTeller.loanCon.r_amnat_com_coll_special_nest_haeder"),
            null, this.GetCurrentColumnValue("LOAN_CONTRACT_NO"), collateral_no);
        }
        private void coll_name_1_1_BeforePrint_1(object sender, System.ComponentModel.CancelEventArgs e)
        {
        ...
        private void coll_name_1_6_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            of_colllat_no(sender, "6");
        }
        private void coll_name_1_7_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            of_colllat_no(sender, "7");
        }

        private void of_coll_seq_no(object sender, string seq_no)
        {
            sc.report.setNestReport(this, sender, Type.GetType("scReport.Reports.rcTeller.loanCon.r_amnat_com_coll_special_nest_guarantor_1"),
        ...
        private void coll_name_2_4_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            of_coll_seq_no(sender, "4");
        }
        ...
        {
            sc.report.setNestReport(this, sender, Type.GetType("scReport.Reports.rcTeller.loanCon.r_amnat_com_coll_special_nest_guarantor_2"),
            null, this.GetCurrentColumnValue("LOAN_CONTRACT_NO"), seq_no);
        }
        ...
        {
            of_coll_name_2(sender, "6");
        }
        private void coll_name_3_3_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            of_coll_name_2(sender, "7");
        }


        private void of_count(object sender, string collateral_no)
        {
            sc.report.setNestReport(this, sender, Type.GetType("scReport.Reports.rcTeller.loanCon.r_amnat_com_coll_special_nest_footer"),
            null, this.GetCurrentColumnValue("LOAN_CONTRACT_NO"), collateral_no);
        }
        private void coll_name_1_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            of_count(sender, "1");
        }
        ...
        private void coll_6_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            of_count(sender, "6");
        }

        private void coll_7_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            of_count(sender, "7");
        }

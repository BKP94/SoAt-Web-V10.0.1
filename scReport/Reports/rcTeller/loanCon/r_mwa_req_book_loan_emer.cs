...
{
    public partial class r_mwa_req_book_loan_emer : DevExpress.XtraReports.UI.XtraReport
    {
        public r_mwa_req_book_loan_emer()
        {
            InitializeComponent();
        }
        private void loan_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanCon.r_mwa_req_book_loan_emer_nest");

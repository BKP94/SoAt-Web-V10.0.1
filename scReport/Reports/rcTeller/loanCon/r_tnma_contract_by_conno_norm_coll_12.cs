...
{
    public partial class r_tnma_contract_by_conno_norm_coll_12 : DevExpress.XtraReports.UI.XtraReport
    {
        public r_tnma_contract_by_conno_norm_coll_12()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanCon.r_tnma_contract_by_conno_norm_coll_12_nest");

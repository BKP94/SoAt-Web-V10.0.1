...
{
    public partial class r_tnma_contract_by_conno_norm_สง_step_pay : DevExpress.XtraReports.UI.XtraReport
    {
        public r_tnma_contract_by_conno_norm_สง_step_pay()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanCon.r_tnma_contract_by_conno_norm_03_nest");

...
{
    public partial class r_bot_loan_req : DevExpress.XtraReports.UI.XtraReport
    {
        public r_bot_loan_req()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanRequest.r_bot_loan_req_nest_old_loan");

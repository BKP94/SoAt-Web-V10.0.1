...
{
    public partial class r_ktm_loan_req_month_by_date : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_loan_req_month_by_date()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanRequest.r_ktm_loan_req_month_by_date_nest");

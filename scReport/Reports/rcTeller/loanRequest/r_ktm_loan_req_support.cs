...
{
    public partial class r_ktm_loan_req_support : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_loan_req_support()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanRequest.r_ktm_loan_req_support_nest_old_loan");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanRequest.r_ktm_loan_req_support_nest_coll");
            sc.report.ofBeforePrint(this, (XRSubreport)sender, this.GetCurrentColumnValue("LOAN_REQUESTMENT_NO"));
        }
    }
}

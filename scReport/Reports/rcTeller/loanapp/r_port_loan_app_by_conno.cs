...
{
    public partial class r_port_loan_app_by_conno : DevExpress.XtraReports.UI.XtraReport
    {
        public r_port_loan_app_by_conno()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanapp.r_port_loan_app_by_conno_nest_coll");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanapp.r_port_loan_app_by_conno_nest_old_loan");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanapp.r_port_loan_app_by_conno_nest_fee");
            sc.report.ofBeforePrint(this, (XRSubreport)sender, this.GetCurrentColumnValue("LOAN_REQUESTMENT_NO"));
        }
    }
}

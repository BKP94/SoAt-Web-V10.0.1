...
{
    public partial class r_tge_loan_create_paid_multi : DevExpress.XtraReports.UI.XtraReport
    {
        public r_tge_loan_create_paid_multi()
        {
            InitializeComponent();
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanapp.r_tge_loan_create_clr_sum_paid_multi");
            sc.report.ofBeforePrint(this, (XRSubreport)sender, this.GetCurrentColumnValue("ACCOUNT_ID"), this.GetCurrentColumnValue("BRANCH_ID"), this.GetCurrentColumnValue("BEGINING_OF_CONTRACT"));
        }

...
{
    public partial class r_tge_loan_create_share : DevExpress.XtraReports.UI.XtraReport
    {
        public r_tge_loan_create_share()
        {
            InitializeComponent();
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanapp.r_tge_loan_create_share_clr");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.loanapp.r_tge_loan_create_share_mpaid");
            sc.report.ofBeforePrint(this, (XRSubreport)sender, this.GetCurrentColumnValue("LOAN_CONTRACT_NO"));

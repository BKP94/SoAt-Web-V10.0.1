...
{
    public partial class r_ktm_loan_paid_atm : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_loan_paid_atm()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonPaid.r_ktm_loan_paid_atm_nest_loan_old");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonPaid.r_ktm_loan_paid_atm_nest");

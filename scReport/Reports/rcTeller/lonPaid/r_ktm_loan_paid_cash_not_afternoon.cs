...
{
    public partial class r_ktm_loan_paid_cash_not_afternoon : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_loan_paid_cash_not_afternoon()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonPaid.r_ktm_loan_paid_cash_not_afternoon_nest_loan_old");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonPaid.r_ktm_loan_paid_cash_not_afternoon_nest");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonPaid.r_ktm_loan_paid_cash_not_afternoon_nest_paid");
            sc.report.ofBeforePrint(this, (XRSubreport)sender, this.GetCurrentColumnValue("LOAN_CONTRACT_NO"));
        }
    }
}

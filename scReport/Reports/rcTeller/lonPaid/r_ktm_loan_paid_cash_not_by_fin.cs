...
{
    public partial class r_ktm_loan_paid_cash_not_by_fin : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_loan_paid_cash_not_by_fin()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonPaid.r_ktm_loan_paid_cash_not_by_fin_nest_loan_old");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonPaid.r_ktm_loan_paid_cash_not_by_fin_nest");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonPaid.r_ktm_loan_paid_cash_not_by_fin_nest_paid");
            sc.report.ofBeforePrint(this, (XRSubreport)sender, this.GetCurrentColumnValue("LOAN_CONTRACT_NO"));
        }

...
{
    public partial class r_mwa_loan_hang : DevExpress.XtraReports.UI.XtraReport
    {
        public r_mwa_loan_hang()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonPaid.r_mwa_loan_hang_nest_loan");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonPaid.r_mwa_loan_hang_nest_coll");

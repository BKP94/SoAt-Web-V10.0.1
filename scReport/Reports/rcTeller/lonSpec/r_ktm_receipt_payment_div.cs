...
{
    public partial class r_ktm_receipt_payment_div : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_receipt_payment_div()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonSpec.r_ktm_receipt_payment_div_nest");

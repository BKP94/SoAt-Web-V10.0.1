...
{
    public partial class r_ktm_receipt_payment_sum_tran : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_receipt_payment_sum_tran()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonSpec.r_ktm_receipt_payment_sum_tran_nest");

...
{
    public partial class r_ktm_receipt_payment_summary : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_receipt_payment_summary()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonSpec.r_ktm_receipt_payment_summary_nest");

...
{
    public partial class r_ktm_receipt_payment_teller : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_receipt_payment_teller()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonSpec.r_ktm_receipt_payment_teller_nest");

...
{
    public partial class r_ktm_receipt_payment_tran : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_receipt_payment_tran()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonSpec.r_ktm_receipt_payment_tran_nest");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonSpec.r_ktm_receipt_payment_tran_nest_verify");
            sc.report.ofBeforePrint(this, (XRSubreport)sender, this.GetCurrentColumnValue("RECEIPT_DATE"), this.GetCurrentColumnValue("BRANCH_ID"));
        }
    }
}

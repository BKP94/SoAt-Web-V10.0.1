...
{
    public partial class r_mwa_receipt_payment_summary : DevExpress.XtraReports.UI.XtraReport
    {
        public r_mwa_receipt_payment_summary()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonSpec.r_mwa_receipt_payment_summary_nest");

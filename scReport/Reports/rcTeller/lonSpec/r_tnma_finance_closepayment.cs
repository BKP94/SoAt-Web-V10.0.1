...
{
    public partial class r_tnma_finance_closepayment : DevExpress.XtraReports.UI.XtraReport
    {
        public r_tnma_finance_closepayment()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setNestReport(this, sender, Type.GetType("scReport.Reports.rcTeller.lonSpec.r_tnma_finance_closepayment_nest"), null, this.GetCurrentColumnValue("RECEIPT_NO"), loan_group_code);
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonSpec.r_tnma_receipt_closepayment_nest2");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonSpec.r_tnma_receipt_closepayment_nest");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonSpec.r_tnma_receipt_closepayment_lon_code_nest");
            sc.report.ofBeforePrint(this, (XRSubreport)sender, this.GetCurrentColumnValue("RECEIPT_DATE"), this.GetCurrentColumnValue("BRANCH_ID"));

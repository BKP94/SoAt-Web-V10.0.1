...
{
    public partial class r_tnma_finance_payment_clr : DevExpress.XtraReports.UI.XtraReport
    {
        public r_tnma_finance_payment_clr()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.lonSpec.r_ktm_receipt_payment_clr_nest");

...
{
    public partial class r_coll_resign_by_memno2 : DevExpress.XtraReports.UI.XtraReport
    {
        public r_coll_resign_by_memno2()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.memColl.r_coll_resign_by_memno2_nest");

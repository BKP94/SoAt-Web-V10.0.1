...
{
    public partial class r_coll_resign_by_memno_total : DevExpress.XtraReports.UI.XtraReport
    {
        public r_coll_resign_by_memno_total()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.memColl.r_coll_resign_by_memno_total_nest_coll");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.memColl.r_coll_resign_by_memno_total_nest_loan");

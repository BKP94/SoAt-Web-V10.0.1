...
{
    public partial class r_coll_resign_by_resign_date : DevExpress.XtraReports.UI.XtraReport
    {
        public r_coll_resign_by_resign_date()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.memColl.r_coll_resign_by_resign_date_nest");

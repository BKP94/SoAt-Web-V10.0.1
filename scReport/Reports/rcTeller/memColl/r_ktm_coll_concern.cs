...
{
    public partial class r_ktm_coll_concern : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_coll_concern()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.memColl.r_ktm_coll_concern_nest_coll");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.memColl.r_ktm_coll_concern_nest_concern");
            sc.report.ofBeforePrint(this, (XRSubreport)sender, this.GetCurrentColumnValue("MEMBERSHIP_NO"));
        }
    }
}

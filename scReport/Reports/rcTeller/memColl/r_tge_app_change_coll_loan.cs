...
{
    public partial class r_tge_app_change_coll_loan : DevExpress.XtraReports.UI.XtraReport
    {
        public r_tge_app_change_coll_loan()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.memColl.r_tge_app_change_coll_loan_old_nest");

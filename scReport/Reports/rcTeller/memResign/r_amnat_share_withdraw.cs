...
{
    public partial class r_amnat_share_withdraw : DevExpress.XtraReports.UI.XtraReport
    {
        public r_amnat_share_withdraw()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.memResign.r_amnat_share_withdraw_nest_aero");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.memResign.r_amnat_share_withdraw_nest");
            sc.report.ofBeforePrint(this, (XRSubreport)sender, this.GetCurrentColumnValue("MEMBERSHIP_NO"));
        }
    }
}

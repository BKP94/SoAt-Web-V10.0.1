...
{
    public partial class r_ktm_share_withdraw : DevExpress.XtraReports.UI.XtraReport
    {
        public r_ktm_share_withdraw()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.memResign.r_ktm_share_withdraw_nest_aero");
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.memResign.r_ktm_share_withdraw_nest");

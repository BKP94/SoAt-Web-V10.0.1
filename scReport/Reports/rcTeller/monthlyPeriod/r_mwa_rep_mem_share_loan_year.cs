...
{
    public partial class r_mwa_rep_mem_share_loan_year : DevExpress.XtraReports.UI.XtraReport
    {
        public r_mwa_rep_mem_share_loan_year()
        {
            InitializeComponent();
        }
        ...
        {
            sc.report.setResource(sender, "scReport.Reports.rcTeller.monthlyPeriod.r_mwa_rep_mem_share_loan_year_nest_coll");
